...
def update_db(order, quote_price):
    ...
    cmd = f"""
        ...
        SET {argstr.lstrip(',')} 
        WHERE uid='{uid}' 
        AND session = '{g.session_name}'
    """.replace("'None'", "NULL")
    if g.DD:
        DDp(f"*┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        DDp(f"*┃DB UPDATE: {order['side']} {order['size']} @ {order['price']})")
        DDp(f"*┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
def get_percent(initial, final):
    p = ((final-initial)/final)*100
    return p
